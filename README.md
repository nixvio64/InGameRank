...
* **StatsAPI** This program makes use of the new stats api that RL put out for us devs read StatsAPI.md if you are interested.
...
## Build yourself
Run pip install -r requirements.txt and run pyinstaller main.spec, if you want the packeged installer you can also run the script inside NSI_BUILDER/installer.nsi 
